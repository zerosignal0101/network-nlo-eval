...
def registry_get_agent_by_id(agent_id: str, repo_root: Path | None = None) -> dict | None:
    """Get agent by ID.
...
def registry_get_agent_by_worktree(worktree_path: str, repo_root: Path | None = None) -> dict | None:
...
def registry_search_agent(search: str, repo_root: Path | None = None) -> dict | None:
...
def registry_get_task_dir(worktree_path: str, repo_root: Path | None = None) -> str | None:
...
def registry_remove_by_worktree(worktree_path: str, repo_root: Path | None = None) -> bool:
